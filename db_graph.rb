...
mysqldump = IO.popen("mysqldump -u -p holmes widget > widget.sql")
Process.waitpid(mysqldump.pid)

puts "Widget table backup finished. widget.sql backup file was created into the directory this script was executed."
